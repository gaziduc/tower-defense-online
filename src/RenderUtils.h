...
public:
    ...
    static void render_text_prompt(SDL_Window* window, SDL_Renderer* renderer, std::string& text, SDL_FRect* dst_pos, SDL_Color fg_color, float ratio_x, float ratio_y);
    static float render_text(SDL_Window* window, SDL_Renderer* renderer, std::string& text, SDL_FRect* dst_pos, SDL_Color fg_color, float ratio_x, float ratio_y);
